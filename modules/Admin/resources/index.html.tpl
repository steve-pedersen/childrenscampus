...
<div class="list-group col-xs-6">
    ...
    <!-- <a class="hidden list-group-item" href="admin/earlystart"><i class="glyphicon glyphicon-pencil" aria-hidden="true"></i> EarlyStart Semester</a> -->
    <a class="list-group-item" href="admin/colophon">Colophon</a>
    <a class="list-group-item" href="admin/apc">Clear memory cache</a>
    ...
    <a class="list-group-item" href="admin/welcome">Manage Welcome Page</a>
