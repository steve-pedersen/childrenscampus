...
<form action="{$smarty.server.REQUEST_URI}" method="post">
	...
	<div class="row email-row">
		<div class="col-xs-8">
			<div class="form-group">
				<label class="lead" for="reservationReminderTime">Reservation Reminder Time: <span class="email-type-description">choose an amount of time to prior to a reservation to send a reminder email.</span></label>
