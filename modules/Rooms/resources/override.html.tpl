...
<form action="{$smarty.server.REQUEST_URI|escape}" method="post" class="form-inline">
    ...
    <div class="form-group">
    	<input class="form-control" type="text" name="checkinDate" id="checkinDate" value="{$reservation->startTime->format('n/j/Y')}" required/>
        <label for="checkinDate">Date</label>
    </div>
    <br>
    <div class="form-group">
    	<input class="form-control" type="text" name="checkinTime" id="checkinTime" value="{$topOfHour->format('g:i A')}" required/>
